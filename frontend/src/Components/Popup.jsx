...
const Popup = ({ message, handleViewBag, handleCheckout, handleClose }) => {
  return (
    <div className="popup-overlay fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="popup relative bg-white rounded-lg shadow-lg p-8 w-full max-w-md transition-opacity duration-300 ease-in-out opacity-100">
...
export default memo(Popup); // Memoize the Popup component to prevent unnecessary re-renders
